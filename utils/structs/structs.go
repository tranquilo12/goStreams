...
// TickersStruct for storing everything about tickers /references/tickers
...
type NewAggStruct struct {
	Ticker         string
	AggBarsResults []AggregatesBarsResults
}
...
func (dp *DatePairs) SetInterval() error {
	dp.Interval = dp.Target.Sub(dp.Start).Hours()
	return nil
}
